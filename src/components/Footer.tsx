...
const Footer = () => {
  ...
  return (
  <footer className="bg-gradient-to-t from-primary/80 to-background border-t py-3 md:py-4">
      <div className="container mx-auto px-4 flex flex-col gap-2 md:gap-1">
        <div className="flex flex-col items-center md:flex-row md:items-center w-full md:w-auto justify-center md:justify-between gap-2 md:gap-4 min-h-0">
          <a href="#" aria-label="Inicio">
            <img src="/img/Logo_Official.png" alt="Logo" className="h-16 w-16 md:h-12 md:w-12 object-contain rounded-full shadow-lg border-2 border-white/40 cursor-pointer" />
          </a>
          <p className="text-xs md:text-sm text-[#17223b] font-semibold tracking-wide whitespace-nowrap text-center md:text-left">
            {t('footerRights').replace('{year}', new Date().getFullYear().toString())}
          </p>
          <div className="flex gap-4 md:gap-3 justify-center md:justify-end">
